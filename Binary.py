...
train_dir = "C:/Users/benja/Desktop/DiabeticRetinopathy/archive/gaussian_filtered_images/gaussian_filtered_images/Binary/train"
val_dir = "C:/Users/benja/Desktop/DiabeticRetinopathy/archive/gaussian_filtered_images/gaussian_filtered_images/Binary/val"
test_dir = "C:/Users/benja/Desktop/DiabeticRetinopathy/archive/gaussian_filtered_images/gaussian_filtered_images/Binary/test"
...
model = CNN()
criterion = nn.BCELoss() # is Binary Model
optimizer = optim.Adam(model.parameters(), lr=0.001)

print("\033[1;31mBeginning training...\033[0m")
for epoch in range(50):  # 20 epochs
    ...
    for inputs, labels in train_loader:
        ...
        # Track accuracy
        predicted = outputs > 0.5  # Sigmoid gives probability, threshold at 0.5
